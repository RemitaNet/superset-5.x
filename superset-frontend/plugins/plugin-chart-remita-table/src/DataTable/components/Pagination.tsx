  ...
  forwardRef(function Pagination(
    ...
    return (
      <div ref={ref} className="dt-pagination" style={style}>
        <ul className="pagination pagination-sm" role="navigation" aria-label="Pagination">
          {pageItems.map(item =>
            typeof item === 'number' ? (
              // actual page number
              <li
              ...
              <li key={item} className="dt-pagination-ellipsis" aria-hidden>
                <span className="dt-pagination-ellipsis">…</span>
              </li>
            ),
          )}
        </ul>
