...
const metadata = new ChartMetadata({
  ...
  description: t(
    'Classic row-by-column spreadsheet like view of a dataset enhanced table with bulk action support. Use tables to showcase a view into the underlying data or to show aggregated metrics.',
  ),
...
export default class RemitaTableChartPlugin extends ChartPlugin<
  TableChartFormData,
  TableChartProps
> {
  constructor() {
