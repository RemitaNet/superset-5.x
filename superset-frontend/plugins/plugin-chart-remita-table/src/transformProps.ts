...
const transformProps = (
  ...
  const derived_enable_bulk_actions =
    (fd.enable_bulk_actions !== undefined ? fd.enable_bulk_actions : (actionsConfig.enable_bulk_actions ?? false));
  const derived_selection_enabled =
    (fd.selection_enabled !== undefined
      ...
      : (actionsConfig.selection_enabled !== undefined
          ...
          // backward-compat: if bulk actions are on but selection_enabled absent, default to true
          : (derived_enable_bulk_actions ? true : false)));
  const derived_selection_mode =
    (fd.selection_mode !== undefined ? fd.selection_mode : (actionsConfig.selection_mode ?? 'multiple'));
  const derived_bulk_action_id_column =
    (fd.bulk_action_id_column !== undefined ? fd.bulk_action_id_column : (actionsConfig.bulk_action_id_column ?? 'id'));
  const derived_bulk_action_label =
    (fd.bulk_action_label !== undefined ? fd.bulk_action_label : (actionsConfig.bulk_action_label ?? 'Bulk Action'));
  const derived_show_split_buttons_in_slice_header =
    (fd.show_split_buttons_in_slice_header !== undefined ? fd.show_split_buttons_in_slice_header : (actionsConfig.show_split_buttons_in_slice_header ?? false));
  const derived_split_actions =
    (fd.split_actions !== undefined ? fd.split_actions : actionsConfig.split_actions);
  const derived_non_split_actions =
    (fd.non_split_actions !== undefined ? fd.non_split_actions : actionsConfig.non_split_actions);
  const derived_enable_table_actions =
    (fd.enable_table_actions !== undefined ? fd.enable_table_actions : (actionsConfig.enable_table_actions ?? false));
  const derived_table_actions_id_column =
    (fd.table_actions_id_column !== undefined ? fd.table_actions_id_column : (actionsConfig.table_actions_id_column ?? 'id'));
  const derived_hide_table_actions_id_column =
    (fd.hide_table_actions_id_column !== undefined ? fd.hide_table_actions_id_column : (actionsConfig.hide_table_actions_id_column ?? false));
  const derived_table_actions =
    (fd.table_actions !== undefined ? fd.table_actions : actionsConfig.table_actions);
  return {
    height,
    width,
    ...
    bulk_action_id_column: derived_bulk_action_id_column,
    ...
    table_actions_id_column: derived_table_actions_id_column,
    hide_table_actions_id_column: derived_hide_table_actions_id_column,
